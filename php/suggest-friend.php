<?php
    ...
    $friend = mysqli_query($conn, "SELECT * FROM users WHERE user_id = ".$friend_id);
    ...
    if (mysqli_num_rows($check) > 0) {
        ...
        mysqli_query($conn, "INSERT INTO friend (frn_user_id, user_id, status, sendBy) VALUES ({$_SESSION['user_id']}, {$friend_id}, {$status}, {$_SESSION['user_id']})");
